...
public class MainActivity extends AppCompatActivity implements SensorEventListener{
    ...
    TextView tv_magn, tv_gyro, tv_acce, tv_gps, tv_ori;
    ToggleButton btn_magn, btn_gyro, btn_acce, btn_gps, btn_ori;

    TextView tv_count;

    //acce
    SensorManager a_sensorManager;
    Sensor acceSensor, gyroSensor, magnSensor, oriSensor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_ori = (TextView) findViewById(R.id.tv_ori);
        ...
        btn_ori = (ToggleButton) findViewById(R.id.btn_ori);
        ...
        oriSensor = a_sensorManager.getDefaultSensor(Sensor.TYPE_ORIENTATION);
        a_sensorManager.registerListener(this, oriSensor, SensorManager.SENSOR_DELAY_NORMAL);
    ...
    public void onSensorChanged(SensorEvent event) {
        switch (event.sensor.getType()){
            ...
            case Sensor.TYPE_ORIENTATION:
                if(btn_ori.isChecked()) {
                    tv_ori.setText("ori1: " + event.values[0] + "\nori2: " + event.values[1] + "\nori3: " + event.values[2]);
                }else{
                    tv_ori.setText("방향 위치");
                }
                break;
        }
    }
